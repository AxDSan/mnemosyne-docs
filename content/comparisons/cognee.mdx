...
**Last updated:** 2026-07-30 · Mnemosyne v3.14.0 · Cognee OSS (as of May 2026)
...
| **Integrations** | Hermes Agent (native, 31 tools, 3 hooks), MCP (28 tools, stdio + SSE), OpenClaw | Framework-agnostic Python library; LangChain integration; growing ecosystem |
...
- You want native Hermes Agent integration with 31 tools and 3 hooks
