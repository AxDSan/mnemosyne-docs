...
**31 tools** and **3 hooks** via `plugin.yaml`.
...
*This page was rewritten for v3.12.0 after community feedback about inaccurate comparisons. Every feature listed for Mnemosyne has been verified against the source code. If anything here is wrong, please open an issue — we'll fix it.*
