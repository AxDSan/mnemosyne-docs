...
| **Stars / community** | New | ~5.1K GitHub stars, Plastic Labs team |
...
| **MCP** | 28 tools, stdio + SSE | Not MCP-native. REST API only. |
...
*Every feature listed for Mnemosyne has been verified against the v3.14.0 source code. Honcho features are based on the open-source repository and Plastic Labs documentation as of May 2026. If anything here is wrong, please open an issue -- we'll fix it.*
