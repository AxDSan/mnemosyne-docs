...
**Last updated:** 2026-07-30 · Mnemosyne v3.14.0 · Mem0 Platform (as of May 2026)
...
| **Database** | SQLite (single file, WAL mode) | Qdrant (vector DB) + Neo4j / FalkorDB (pluggable knowledge graph) |
...
| **Knowledge graph** | TripleStore (subject-predicate-object, temporal) | Neo4j / FalkorDB property graph (Pro tier only, $249/mo) |
...
| **Integrations** | Hermes Agent (native, 31 tools, 3 hooks), MCP (28 tools, stdio + SSE), OpenClaw | LangChain, LlamaIndex, CrewAI, AutoGen, OpenAI Agents SDK |
...
| **Starter** | $19/mo | 50,000 adds/month, 10 users, email support |
| **Growth** | $79/mo | 100,000 adds/month, 25 users, knowledge graph, priority support |
| **Pro** | $249/mo | 500,000 adds/month, knowledge graph, unlimited users, priority support |
...
- You're building for **Hermes Agent** and want deep, native integration (31 tools, hooks)
...
*Every claim about Mem0 has been verified against their public docs and pricing page (as of May 2026). Every claim about Mnemosyne has been verified against the v3.14.0 source code. If anything here is wrong, please open an issue — we'll fix it.*
