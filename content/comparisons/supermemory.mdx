...
**Last updated:** 2026-07-30 · Mnemosyne v3.14.0 · SuperMemory (as of May 2026)
...
| **Hermes Agent** | Native (in-process, 31 tools, 3 hooks) | Via HTTP proxy (no native plugin) |
| **OpenClaw** | Planned (adapter not yet built) | Via HTTP proxy |
| **MCP** | 28 tools, stdio + SSE | Custom HTTP API via Memory Router |
...
| **Integrations** | Hermes Agent (native, 31 tools, 3 hooks), MCP (28 tools, stdio + SSE), OpenClaw | Memory Router (OpenAI-compatible proxy), Notion, Slack, Google Drive connectors |
