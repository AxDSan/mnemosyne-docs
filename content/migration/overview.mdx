...
Mnemosyne ships importers for 8 major memory providers. Each importer handles extraction, field mapping, and data import end to end. You don't need to write export scripts or manually map fields.
...
| **Holographic** | Local SQLite DB | `--from holographic [--db  ...]` |
...
- [From Holographic](/migration/from-holographic) — Local SQLite, trust scores, entity links
